<?php $__env->startSection('content'); ?>
    <div class="container-sm mt-5">
        <form action="<?php echo e(route('barang.update', ['barang' => $barang->kode_barang])); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> rounded-4" type="text"
                                ...
                                value="<?php echo e($errors->any() ? old('harga_barang') : $barang->harga_barang); ?>"
...
unset($__errorArgs, $__bag); ?> rounded-4" type="text "
                                ...
                                value="<?php echo e($errors->any() ? old('deskripsi_barang') : $barang->deskripsi_barang); ?>"
                            ...
                            <select name="satuan" id="satuan" class="form-select rounded-4">
                                ...
                                <?php $__currentLoopData = $satuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuanku): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($satuanku->id); ?>"
                                        <?php echo e($selected == $satuanku->id ? 'selected' : ''); ?>>
                                        <?php echo e($satuanku->kode_satuan .
                                            ' -
                                                ' .
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\denny\masterBarangUts\resources\views/barang/edit.blade.php ENDPATH**/ ?>