            ...
            <div class="card mb-2" style="border-radius: .5rem;">
                <div class="row g-0">
                    <div class="col-md-4 gradient-custom text-center text-white"
                        ...
                        <img src="{{ Vite::asset('resources/images/foto.jpeg') }}" class="img-fluid my-5 rounded 5"
                            style="height:300px" alt="">
                        <h5 class="text-dark">Denny Daffa Rizaldy</h5>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row pt-1">
                                <div class="col-6 mb-3">
                                    <h6>NIM</h6>
                                    <p class="text-muted">1204210109</p>
                                </div>
                                <div class="col-6 mb-3">
                                    <h6>Email</h6>
                                    <p class="text-muted">denny.daffa.21@student.is.ittelkom-sby.ac.id</p>
                                </div>
                            </div>
                            <h6>Pengalaman</h6>
                            <hr class="mt-0 mb-4">
